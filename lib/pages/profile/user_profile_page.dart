...
import 'package:roamsg/pages/guide/guide_profile_page.dart';
// import '../guide/guide_register_page.dart';
import '../user/user_booking_history_page.dart';
import 'package:roamsg/pages/auth/login_page.dart';
...
class _ProfilePageState extends State<ProfilePage> {
                  ...
                  items: [
                    _MenuItemData(
                      ...
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (_) => const UserBookingHistoryPage()),
                        );
                      },
                    ),
                  ],
  ...
  await FirebaseAuth.instance.signOut();
    ...
    // đóng hết các page con để quay lại root (nơi có AuthGate)
